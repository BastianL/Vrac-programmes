...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname file) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
...
(define Docs (make-dir.v3 "Docs" '() (list read!)))
(define Libs (make-dir.v3 "Libs" (list Code Docs) '() ))
(define read!1 (make-file "read!" 10 ""))
(define TS (make-dir.v3 "TS" (list Text Libs) (list read!1)))

(define (how-many dir)
  (cond
    [(empty? (dir.v3-dirs dir)) (length (dir.v3-files dir))]
    [else (+ (length (dir.v3-files dir)) (for/sum ([d (dir.v3-dirs dir)])(how-many d)))]))
